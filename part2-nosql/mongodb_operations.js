// Connect to MongoDB (mongosh or Node.js with MongoDB driver)
// Database: fleximart_nosql
use fleximart_nosql;

// 1. Drop old collection if exists
db.products.drop();

// 2. Insert all 12 products
...
// 3. Basic Query - Electronics under price 50000
db.products.find(
  {category: "Electronics", price: {$lt: 50000}},
  {name: 1, price: 1, stock: 1, _id: 0}
);

// 4. Average rating per product >= 4
...
// 5. Update - Add new review for ELEC001
db.products.updateOne(
  {product_id: "ELEC001"},
  {$push: {reviews: {user_id: "U999", username: "TestUser", rating: 4, comment: "Good value", date: new Date()}}}
);

// 6. Complex aggregation - average price by category
db.products.aggregate([
